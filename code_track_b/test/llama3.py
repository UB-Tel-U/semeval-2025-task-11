...
os.environ["CHATAI_API_KEY"] = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjEwMDdmZDViLWZjODEtNDQ0NS1hOTcwLWNkYzI4YjVmYzE1ZiJ9.Xz2lJjyMNuwhH8DyheDfc_n6qnVEg0BhGSBdwmh8Sdo"
...
for file in os.listdir(folder_path):
    if file.endswith(".csv") and file=="amh.csv":
        ...
        df.to_csv(f'public_data_test/track_b/pred_test/pred_{file}', index=False)
        break
