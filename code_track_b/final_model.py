...
train_folder_path = "../public_data_test/track_b/train"
dev_folder_path = "../public_data_test/track_b/dev"
...
def compute_metrics(eval_preds):
    ...
    overall_accuracy = accuracy_score(labels.argmax(axis=-1), predictions)
    overall_f1 = f1_score(labels.argmax(axis=-1), predictions, average='macro', zero_division=0)
    return { 'overall_accuracy': overall_accuracy, 'overall_f1': overall_f1 }
