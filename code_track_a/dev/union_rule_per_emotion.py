...
pred_path = os.path.join("public_data_test/track_a/pred_dev_union/", f"{combo_str}/")
...
for csv_file in os.listdir(ref_path):
    if csv_file.endswith(".csv"):
        ...
        per_label_file = os.path.join("code_track_a/dev/evaluation/union_rule/per_label/", f"{combo_str}_{os.path.splitext(csv_file)[0]}.csv")
...
summary_file = f"code_track_a/dev/evaluation/union_rule/per_label/{combo_str}_average.csv"
