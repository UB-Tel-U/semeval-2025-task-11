...
os.environ["CHATAI_API_KEY"] = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjEwMDdmZDViLWZjODEtNDQ0NS1hOTcwLWNkYzI4YjVmYzE1ZiJ9.ZL6aIGnUwCCd0ZspM-P_5FMawI5nCPuBc2XrQl-LfVQ"
...
for file in os.listdir(folder_path):
    if file.endswith(".csv") and file=="tat.csv":
        ...
        output_path = f'../../public_data_test/track_a/pred_dev_llama3/pred_{file}'
