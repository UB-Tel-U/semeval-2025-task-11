...
model = AutoModelForSequenceClassification.from_pretrained("../code_track_c/model_xlm-roberta")
...
folder_path = "../public_data_test/track_c/test"
dataframes = []
...
for file in os.listdir(folder_path):
    if file.endswith(".csv"):
        ...
        df.to_csv(f'../public_data_test/track_c/pred_test/pred_{file}', index=False)